...
if __name__ == "__main__":
    ...
    args.path_to_checkpoint = "/tmp/llama"
    os.mkdir(args.path_to_checkpoint)
    snapshot_download(repo_id=args.model_name, allow_patterns=["*.bin", "*.json","*.model"], ignore_patterns=["*.safetensors","*.safetensors.index.json"],local_dir=args.path_to_checkpoint,local_dir_use_symlinks=False)
    args.config_file = os.path.join(args.path_to_checkpoint,"config.json")
